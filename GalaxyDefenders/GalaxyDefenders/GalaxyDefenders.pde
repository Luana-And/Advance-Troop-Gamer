...
// Redimensionar para manter tamanho adequado no jogo
playerImg.resize(100, 100);  // tamanho do jogador
enemyImg.resize(90, 90);   // tamanho do inimigo
...
void keyPressed() {
  ...
  if (gameOver && (key == 'r' || key == 'R')) {
    startGame(); // reinicia com mesma dificuldade
  }
}
